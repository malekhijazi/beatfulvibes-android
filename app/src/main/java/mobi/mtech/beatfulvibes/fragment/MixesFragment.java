...
public class MixesFragment extends CoreListFragment<Track> {
    ...
    private void getTracks() {
        try {
            ...
            NetworkManager.mixes(mContext, params, new CoreNetworkManager.Listener<MixesDataWrapper>() {
                @Override
                public void onSuccess(MixesDataWrapper response) {
