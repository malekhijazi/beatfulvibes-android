...
public class SearchArtistAdapter extends CoreListAdapter<Artist> {
    /**
     ...
     */
    public SearchArtistAdapter(Context context, RecyclerView recyclerView, List<Artist> items) {
    ...
    public CoreHolder onCreateViewHolder(ViewGroup parent) {
        return new ArtistHolder(inflate(parent, R.layout.view_search_artist), getItemClickListener());
    }
}
